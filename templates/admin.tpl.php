...
<div id="header">
    <nav class="navbar navbar-dark bg-dark">
        <span>
             <a href="/admin" class="navbar-brand">Administração</a>
            <span class="navbar-text">Painel de admnistração do site</span>
        </span>
    ...
    <div class="row">
        <div class="col">
            <ul id="main-menu" class="nav flex-column nav-pills bg-secondary text-white p-2">
                ...
                <li class="nav-item">
                    <a href="/admin/pages" class="nav-link <?php if (resolve('/admin/pages.*')) echo "active" ?>">
                        <i class="far fa-file-alt"></i> Páginas
                    </a>
                </li>
                <li class="nav-item">
                    <a href="/admin/users" class="nav-link <?php if (resolve('/admin/users.*')) echo "active" ?>">
